...
export const metadata: Metadata = {
  title: "Tadrart Rouge Expedition | Sahara Desert Tours",
  description: "Discover the breathtaking red dunes and prehistoric rock art of Tadrart Rouge in a 7-day Sahara expedition.",
};

import Image from "next/image";
import { Header, Footer, AccordionItem } from "../../components";
import PinnedItinerary from "../../components/PinnedItinerary";
import { destinationGroups, tadrartGallery, tadrartItineraryImages, tadrartGalleryFiltered, tourDates } from "../../content";
        ...
        <div className="dest-details-left">
          ...
          <div className="tour-dates-container reveal" style={{ animationDelay: "0.2s", marginTop: "40px" }}>
            <div className="dates-header">
              ...
              <h3 className="dates-title">Upcoming Departures ({tourDates[0].duration})</h3>
            </div>
