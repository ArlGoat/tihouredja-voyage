...
export const metadata: Metadata = {
  title: "Ihrir & Erg Admer Tour | Sahara Expeditions",
  description: "Explore the stunning oasis of Ihrir and the vast sand dunes of Erg Admer in an unforgettable 7-day Sahara journey.",
};

import Image from "next/image";
import { Header, Footer } from "../../components";
import PinnedItinerary from "../../components/PinnedItinerary";
import { destinationGroups, ihrirGallery, ihrirItineraryImages, ihrirGalleryFiltered, tourDates } from "../../content";
        ...
        <div className="dest-details-left">
          ...
          <div className="tour-dates-container reveal" style={{ animationDelay: "0.2s", marginTop: "40px" }}>
            <div className="dates-header">
              ...
              <h3 className="dates-title">Upcoming Departures ({tourDates[1].duration})</h3>
            </div>
