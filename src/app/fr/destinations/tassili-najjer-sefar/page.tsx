...
export const metadata: Metadata = {
  title: "Tassili N'Ajjer Sefar | Expéditions Désert du Sahara",
  description: "Embarquez pour un trek de 8 jours dans le Tassili n'Ajjer et Sefar, le plus grand musée à ciel ouvert d'art rupestre préhistorique au monde.",
};

import Image from "next/image";
import { Header, Footer } from "../../../components";
import SimpleItinerary from "../../../components/SimpleItinerary";
import { destinationGroups, sefarGallery, tourDates } from "../../../frContent";
        ...
        <div className="dest-details-left">
          ...
          <div className="tour-dates-container reveal" style={{ animationDelay: "0.2s", marginTop: "40px" }}>
            <div className="dates-header">
              ...
              <h3 className="dates-title">Prochains Départs ({tourDates[2].duration})</h3>
            </div>
