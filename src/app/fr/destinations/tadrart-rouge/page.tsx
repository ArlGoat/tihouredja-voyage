...
export const metadata: Metadata = {
  title: "Expédition Tadrart Rouge | Circuits Désert du Sahara",
  description: "Découvrez les époustouflantes dunes rouges et l'art rupestre préhistorique de la Tadrart Rouge lors d'une expédition de 7 jours dans le Sahara.",
};

import Image from "next/image";
import { Header, Footer, AccordionItem } from "../../../components";
import PinnedItinerary from "../../../components/PinnedItinerary";
import { destinationGroups, tadrartGallery, tadrartItineraryImages, tadrartGalleryFiltered, tourDates } from "../../../frContent";
import LightboxGallery from "../../../destinations/LightboxGallery";

const destination = destinationGroups[0];

export default function TadrartRougePage() {
  return (
    <main>
      <Header locale="fr" />

      {/* Hero */}
      <section className="page-hero tadrart-page-hero">
      ...
      <section className="dest-details-section">
        <div className="dest-details-left">
          ...
          <div className="tour-dates-container reveal" style={{ animationDelay: "0.2s", marginTop: "40px" }}>
            <div className="dates-header">
              ...
              <h3 className="dates-title">Prochains Départs ({tourDates[0].duration})</h3>
            </div>
            <div className="dates-grid">
              {tourDates[0].dates.map((date, i) => (
        ...
        <div className="dest-details-right reveal" style={{ animationDelay: "0.3s" }}>
          <div className="dest-editorial-image">
            <Image src={tadrartGallery[0]} alt="Tadrart Desert" fill />
          </div>
          <div className="dest-editorial-image offset-image">
            <Image src={tadrartGallery[1]} alt="Tadrart Exploring" fill />
          </div>
        </div>
      </section>
      ...
      <section className="destination-gallery-section page-section" style={{ paddingTop: 0 }}>
        <article className="destination-gallery-block reveal">
          <LightboxGallery images={tadrartGalleryFiltered} altPrefix={destination.name} />
        </article>
      </section>
